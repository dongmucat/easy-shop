  ...
  <div class="catogory-container">
    ...
    <el-card class="box-card" shadow='hover'>
      ...
      <el-row style="margin-bottom:20px">
        <el-col>
          <el-button type="primary" @click="getParentCateList()">点击添加分类</el-button>
        </el-col>
      </el-row>
    ...
    <!-- 添加分类的弹窗区域 -->
    <el-dialog title="添加分类" :visible.sync="addCateDialogFormVisible" @close="addCateDialogClosed()">
      <!-- 添加分类表单 -->
    ...
    methods: {
      ...
      editCate() {
        this.$refs.editCateFormRef.validate(async valid => {
          ...
          const {
            data: res
          } = await this.$http.put(`categories/${this.editCateForm.cat_id}`, this.editCateForm)
      ...
      async deleteCate(id) {
        ...
        */
        ...
        if (confirmResult !== 'confirm') {
          return this.$message.info('已撤销删除分类操作')
        }
        //如果确定
        const {
          data: res
